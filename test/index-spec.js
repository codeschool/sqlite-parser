...
describe('sqlite-parser', function() {
  ...
  it('expression unary 1', function(done) {
    var resultTree = '{"statement":[{"modifier":null,"type":"statement","variant":"select","from":[{"type":"identifier","variant":"table","name":"hats","alias":null,"index":null}],"where":null,"group":null,"result":[{"type":"expression","format":"unary","variant":"operation","expression":{"type":"identifier","variant":"column","name":"bees"},"operator":"not","alias":"b"}],"distinct":false,"all":false,"order":null,"limit":null}]}';
    tree.equals(resultTree, this, done);
  });

  it('expression table 1', function(done) {
    var resultTree = '{"statement":[{"modifier":null,"type":"statement","variant":"select","from":{"type":"map","variant":"join","source":{"type":"identifier","variant":"table","name":"inventory","alias":null,"index":null},"map":[{"type":"join","variant":"inner join","source":{"type":"identifier","variant":"table","name":"ham","alias":null,"index":null},"on":{"type":"expression","format":"binary","variant":"operation","operation":"=","left":{"type":"identifier","variant":"column","name":"inventory.variety"},"right":{"type":"identifier","variant":"column","name":"ham.type"},"modifier":null},"using":null}]},"where":null,"group":null,"result":[{"type":"identifier","variant":"star","name":"*"}],"distinct":false,"all":false,"order":null,"limit":null,"with":{"type":"with","recursive":false,"expression":[{"type":"expression","format":"table","name":"ham","expression":{"type":"statement","variant":"select","from":[{"type":"identifier","variant":"table","name":"hams","alias":null,"index":null}],"where":null,"group":null,"result":[{"type":"identifier","variant":"column","name":"type","alias":null}],"distinct":false,"all":false,"order":null,"limit":null},"columns":null}]}}]}';
    tree.equals(resultTree, this, done);
  });
  ...
  it('expression grouping 7', function(done) {
    var resultTree = '{"statement":[{"modifier":null,"type":"statement","variant":"create","format":"index","target":{"type":"identifier","variant":"index","name":"bees.hive_state"},"where":[{"type":"expression","format":"binary","variant":"operation","operation":"or","left":{"type":"expression","format":"unary","variant":"operation","expression":{"type":"identifier","variant":"column","name":"happiness"},"operator":"not"},"right":{"type":"expression","format":"binary","variant":"operation","operation":"and","left":{"type":"expression","format":"unary","variant":"operation","expression":{"type":"identifier","variant":"column","name":"ANGER"},"operator":"~"},"right":{"type":"expression","format":"binary","variant":"operation","operation":"is not","left":{"type":"identifier","variant":"column","name":"anger"},"right":{"type":"literal","variant":"decimal","value":"0"},"modifier":null},"modifier":null},"modifier":null}],"on":{"target":"hive","columns":[{"type":"identifier","variant":"column","format":"indexed","direction":"asc","name":"happiness","collate":null},{"type":"identifier","variant":"column","format":"indexed","direction":"desc","name":"anger","collate":null}]},"conditions":[],"unique":false}]}';
    tree.equals(resultTree, this, done);
  });

  it('expression parenthesis 1', function(done) {
    var resultTree = '{"statement":[{"modifier":null,"type":"statement","variant":"select","from":[{"type":"identifier","variant":"table","name":"hats","alias":null,"index":null}],"where":[{"type":"expression","format":"binary","variant":"operation","operation":"or","left":{"type":"identifier","variant":"column","name":"hat"},"right":{"type":"expression","format":"binary","variant":"operation","operation":"and","left":{"type":"identifier","variant":"column","name":"shirt"},"right":{"type":"expression","format":"binary","variant":"operation","operation":"and","left":{"type":"expression","format":"binary","variant":"operation","operation":"or","left":{"type":"identifier","variant":"column","name":"shoes"},"right":{"type":"identifier","variant":"column","name":"wig"},"modifier":null},"right":{"type":"identifier","variant":"column","name":"pants"},"modifier":null},"modifier":null},"modifier":null}],"group":null,"result":[{"type":"identifier","variant":"star","name":"*"}],"distinct":false,"all":false,"order":null,"limit":null}]}';
    tree.equals(resultTree, this, done);
  });

  it('expression parenthesis 2', function(done) {
    var resultTree = '{"statement":[{"modifier":null,"type":"statement","variant":"select","from":[{"type":"identifier","variant":"table","name":"hats","alias":null,"index":null}],"where":[{"type":"expression","format":"binary","variant":"operation","operation":"and","left":{"type":"expression","format":"binary","variant":"operation","operation":"or","left":{"type":"expression","format":"binary","variant":"operation","operation":"!=","left":{"type":"literal","variant":"decimal","value":"1"},"right":{"type":"literal","variant":"decimal","value":"2"},"modifier":null},"right":{"type":"expression","format":"binary","variant":"operation","operation":"!=","left":{"type":"literal","variant":"decimal","value":"3"},"right":{"type":"literal","variant":"decimal","value":"4"},"modifier":null},"modifier":null},"right":{"type":"expression","format":"binary","variant":"operation","operation":"==","left":{"type":"literal","variant":"decimal","value":"3"},"right":{"type":"literal","variant":"decimal","value":"3"},"modifier":null},"modifier":null}],"group":null,"result":[{"type":"identifier","variant":"star","name":"*"}],"distinct":false,"all":false,"order":null,"limit":null}]}';
    tree.equals(resultTree, this, done);
  });
  ...
  it('select alt syntax', function(done) {
    var resultTree = '{"statement":[{"modifier":null,"type":"statement","variant":"select","result":[{"type":"values","variant":"list","values":[{"type":"literal","variant":"decimal","value":"1"},{"type":"literal","variant":"decimal","value":"2"},{"type":"literal","variant":"decimal","value":"3"}]},{"type":"values","variant":"list","values":[{"type":"literal","variant":"decimal","value":"4"},{"type":"literal","variant":"decimal","value":"5"},{"type":"literal","variant":"decimal","value":"6"}]}],"from":null,"where":null,"group":null,"order":[{"direction":"DESC","expression":{"type":"identifier","variant":"column","name":"ham"},"collate":null}],"limit":null}]}';
    tree.equals(resultTree, this, done);
  });

  it('select parts 1', function(done) {
    var resultTree = '{"statement":[{"modifier":null,"type":"statement","variant":"select","from":[{"type":"identifier","variant":"table","name":"hats","alias":"h","index":null}],"where":[{"type":"expression","format":"binary","variant":"operation","operation":"==","left":{"type":"identifier","variant":"column","name":"h.color"},"right":{"type":"literal","variant":"string","value":"red"},"modifier":null}],"group":{"expression":[{"type":"identifier","variant":"column","name":"h.color"},{"type":"identifier","variant":"column","name":"h.material"}],"having":{"type":"expression","format":"binary","variant":"operation","operation":">=","left":{"type":"function","name":"COUNT","distinct":false,"args":[{"type":"identifier","variant":"column","name":"h.quantity"}]},"right":{"type":"literal","variant":"decimal","value":"200"},"modifier":null}},"result":[{"type":"identifier","variant":"star","name":"*"}],"distinct":false,"all":false,"order":[{"direction":"DESC","expression":{"type":"identifier","variant":"column","name":"h.color"},"collate":null}],"limit":{"start":{"type":"literal","variant":"decimal","value":"20"},"offset":{"type":"literal","variant":"decimal","value":"10"}}}]}';
    tree.equals(resultTree, this, done);
  });

  it('basic subquery', function(done) {
    var resultTree = '{"statement":[{"modifier":null,"type":"statement","variant":"select","from":{"type":"map","variant":"join","source":{"alias":"z","type":"statement","variant":"select","from":[{"type":"identifier","variant":"table","name":"bananas","alias":"b","index":null}],"where":null,"group":null,"result":[{"type":"identifier","variant":"column","name":"b.color","alias":null}],"distinct":false,"all":false,"order":null,"limit":null},"map":[{"type":"join","variant":"join","source":{"type":"identifier","variant":"table","name":"apples","alias":"a","index":null},"on":{"type":"expression","format":"binary","variant":"operation","operation":"=","left":{"type":"identifier","variant":"column","name":"a.color"},"right":{"type":"identifier","variant":"column","name":"b.color"},"modifier":null},"using":null}]},"where":null,"group":null,"result":[{"type":"identifier","variant":"column","name":"a.color","alias":null}],"distinct":false,"all":false,"order":null,"limit":null}]}';
    tree.equals(resultTree, this, done);
  });

  it('basic union', function(done) {
    var resultTree = '{"statement":[{"modifier":null,"type":"statement","variant":"compound","statement":{"type":"statement","variant":"select","from":[{"type":"identifier","variant":"table","name":"a","alias":null,"index":null}],"where":null,"group":null,"result":[{"type":"identifier","variant":"star","name":"*"}],"distinct":false,"all":false},"compound":[{"type":"compound","variant":"union","statement":{"type":"statement","variant":"select","from":[{"type":"identifier","variant":"table","name":"b","alias":null,"index":null}],"where":null,"group":null,"result":[{"type":"identifier","variant":"star","name":"*"}],"distinct":false,"all":false}}],"order":null,"limit":null}]}';
    tree.equals(resultTree, this, done);
  });

  it('select qualified table 1', function(done) {
    var resultTree = '{"statement":[{"modifier":null,"type":"statement","variant":"select","from":[{"type":"identifier","variant":"table","name":"bees","alias":"b","index":"bees_index"}],"where":null,"group":null,"result":[{"type":"identifier","variant":"star","name":"*"}],"distinct":false,"all":false,"order":null,"limit":null}]}';
    tree.equals(resultTree, this, done);
  });
  ...
  it('basic function', function(done) {
    var resultTree = '{"statement":[{"modifier":null,"type":"statement","variant":"select","from":[{"type":"identifier","variant":"table","name":"apples","alias":null,"index":null}],"where":null,"group":null,"result":[{"type":"function","name":"COUNT","distinct":false,"args":[{"type":"identifier","variant":"star","name":"*"}],"alias":null},{"type":"function","name":"MAX","distinct":false,"args":[{"type":"identifier","variant":"column","name":"price"}],"alias":null}],"distinct":false,"all":false,"order":null,"limit":null}]}';
    tree.equals(resultTree, this, done);
  });

  it('function mixed args', function(done) {
    var resultTree = '{"statement":[{"modifier":null,"type":"statement","variant":"select","from":[],"where":null,"group":null,"result":[{"type":"function","name":"MYFUNC","distinct":false,"args":[{"type":"identifier","variant":"column","name":"col"},{"type":"literal","variant":"decimal","value":"1.2"},{"type":"literal","variant":"string","value":"str"}],"alias":"Super Func"}],"distinct":false,"all":false,"order":null,"limit":null}]}';
    tree.equals(resultTree, this, done);
  });
  ...
  it('join types 1', function(done) {
    var resultTree = '{"statement":[{"modifier":null,"type":"statement","variant":"select","from":{"type":"map","variant":"join","source":{"type":"identifier","variant":"table","name":"Movies","alias":"m","index":null},"map":[{"type":"join","variant":"inner join","source":{"alias":"r","type":"statement","variant":"select","from":[{"type":"identifier","variant":"table","name":"Rooms","alias":"r2","index":null}],"where":[{"type":"expression","format":"binary","variant":"operation","operation":">=","left":{"type":"identifier","variant":"column","name":"r2.seats"},"right":{"type":"literal","variant":"decimal","value":"50"},"modifier":null}],"group":null,"result":[{"type":"identifier","variant":"column","name":"r2.movie_id","alias":null}],"distinct":false,"all":false,"order":null,"limit":null},"on":{"type":"expression","format":"binary","variant":"operation","operation":"and","left":{"type":"expression","format":"binary","variant":"operation","operation":"=","left":{"type":"identifier","variant":"column","name":"m.id"},"right":{"type":"identifier","variant":"column","name":"r.movie_id"},"modifier":null},"right":{"type":"expression","format":"binary","variant":"operation","operation":"!=","left":{"type":"identifier","variant":"column","name":"m.title"},"right":{"type":"literal","variant":"string","value":"Batman"},"modifier":null},"modifier":null},"using":null}]},"where":null,"group":null,"result":[{"type":"identifier","variant":"column","name":"m.title","alias":null},{"type":"identifier","variant":"column","name":"r.id","alias":"Theatre Number"}],"distinct":false,"all":false,"order":null,"limit":null}]}';
    tree.equals(resultTree, this, done);
  });

  it('join types 2', function(done) {
    var resultTree = '{"statement":[{"modifier":null,"type":"statement","variant":"select","from":{"type":"map","variant":"join","source":{"type":"identifier","variant":"table","name":"Movies","alias":"m","index":null},"map":[{"type":"join","variant":"left outer join","source":{"type":"identifier","variant":"table","name":"Rooms","alias":"r","index":null},"on":{"type":"expression","format":"binary","variant":"operation","operation":"=","left":{"type":"identifier","variant":"column","name":"m.id"},"right":{"type":"identifier","variant":"column","name":"r.movie_id"},"modifier":null},"using":null}]},"where":null,"group":null,"result":[{"type":"identifier","variant":"column","name":"m.title","alias":null},{"type":"identifier","variant":"column","name":"r.id","alias":"Theatre Number"}],"distinct":false,"all":false,"order":null,"limit":null}]}';
    tree.equals(resultTree, this, done);
  });
  ...
  it('basic insert', function(done) {
    var resultTree = '{"statement":[{"type":"statement","variant":"insert","into":{"target":{"type":"identifier","variant":"table","name":"concessions"},"columns":[{"type":"identifier","variant":"column","name":"item"},{"type":"identifier","variant":"column","name":"size"},{"type":"identifier","variant":"column","name":"id"},{"type":"identifier","variant":"column","name":"price"}]},"action":"insert","modifier":null,"or":null,"result":[{"type":"values","variant":"list","values":[{"type":"literal","variant":"string","value":"Nachos"},{"type":"literal","variant":"string","value":"Regular"},{"type":"literal","variant":"null","value":"null"},{"type":"literal","variant":"null","value":"null"}]},{"type":"values","variant":"list","values":[{"type":"literal","variant":"string","value":"Pizza"},{"type":"literal","variant":"null","value":"null"},{"type":"literal","variant":"decimal","value":"8"},{"type":"literal","variant":"decimal","value":"2.00"}]}]}]}';
    tree.equals(resultTree, this, done);
  });
  ...
  it('insert into default', function(done) {
    var resultTree = '{"statement":[{"modifier":null,"type":"statement","variant":"insert","into":{"target":{"type":"identifier","variant":"table","name":"apples"},"columns":[{"type":"identifier","variant":"column","name":"a"},{"type":"identifier","variant":"column","name":"b"},{"type":"identifier","variant":"column","name":"c"}]},"action":"insert","or":null,"result":{"type":"values","variant":"default","values":null}}]}';
    tree.equals(resultTree, this, done);
  });
  ...
  it('basic create table', function(done) {
    var resultTree = '{"statement":[{"type":"statement","variant":"create","modifier":null,"format":"table","temporary":false,"target":{"type":"identifier","variant":"table","name":"advertisements"},"conditions":[],"modifier":null,"definition":[{"type":"definition","variant":"column","name":"id","definition":[{"name":null,"type":"constraint","variant":"primary key","conflict":null,"direction":null,"modififer":null,"autoIncrement":false}],"datatype":{"type":"datatype","format":"int","affinity":"integer","args":[]}},{"type":"definition","variant":"column","name":"name","definition":[],"datatype":{"type":"datatype","format":"varchar","affinity":"text","args":[{"type":"literal","variant":"decimal","value":"50"}]}},{"type":"definition","variant":"column","name":"category","definition":[],"datatype":{"type":"datatype","format":"varchar","affinity":"text","args":[{"type":"literal","variant":"decimal","value":"15"}]}},{"type":"definition","variant":"column","name":"cost","definition":[],"datatype":{"type":"datatype","format":"int","affinity":"integer","args":[]}}]}]}';
    tree.equals(resultTree, this, done);
  });

  it('create table alt syntax', function(done) {
    var resultTree = '{"statement":[{"modifier":null,"type":"statement","variant":"create","format":"table","temporary":false,"target":{"type":"identifier","variant":"table","name":"bees"},"conditions":[],"definition":[{"type":"statement","variant":"select","from":[{"type":"identifier","variant":"table","name":"old_bees","alias":null,"index":null}],"where":[{"type":"expression","format":"binary","variant":"operation","operation":"is not","left":{"type":"identifier","variant":"column","name":"name"},"right":{"type":"literal","variant":"null","value":"null"},"modifier":null}],"group":null,"result":[{"type":"identifier","variant":"column","name":"name","alias":null},{"type":"identifier","variant":"column","name":"color","alias":null},{"type":"identifier","variant":"column","name":"legs","alias":null},{"type":"identifier","variant":"column","name":"id","alias":null}],"distinct":false,"all":false,"order":null,"limit":null}]}]}';
    tree.equals(resultTree, this, done);
  });

  it('create foreign key 1', function(done) {
    var resultTree = '{"statement":[{"modifier":null,"type":"statement","variant":"create","format":"table","temporary":false,"target":{"type":"identifier","variant":"table","name":"Bees"},"conditions":[],"definition":[{"type":"definition","variant":"column","name":"id","definition":[{"name":null,"type":"constraint","variant":"primary key","conflict":null,"direction":null,"modififer":null,"autoIncrement":false}],"datatype":{"type":"datatype","format":"int","affinity":"integer","args":[]}},{"type":"definition","variant":"column","name":"color","definition":[],"datatype":{"type":"datatype","format":"int","affinity":"integer","args":[]}},{"type":"definition","variant":"column","name":"hive_id","definition":[{"name":null,"type":"constraint","variant":"unique","conflict":null}],"datatype":{"type":"datatype","format":"int","affinity":"integer","args":[]}},{"type":"definition","variant":"constraint","name":null,"definition":[{"type":"constraint","variant":"foreign key","target":{"type":"identifier","variant":"table","name":"Hives"},"columns":null,"action":null,"deferrable":null}],"columns":[{"type":"identifier","variant":"column","name":"hive_id"}]}]}]}';
    tree.equals(resultTree, this, done);
  });

  it('create foreign key 2', function(done) {
    var resultTree = '{"statement":[{"modifier":null,"type":"statement","variant":"create","format":"table","temporary":false,"target":{"type":"identifier","variant":"table","name":"Bees"},"conditions":[],"definition":[{"type":"definition","variant":"column","name":"id","definition":[{"name":null,"type":"constraint","variant":"primary key","conflict":null,"direction":null,"modififer":null,"autoIncrement":false}],"datatype":{"type":"datatype","format":"int","affinity":"integer","args":[]}},{"type":"definition","variant":"column","name":"color","definition":[],"datatype":{"type":"datatype","format":"int","affinity":"integer","args":[]}},{"type":"definition","variant":"column","name":"hive_id","definition":[{"name":null,"type":"constraint","variant":"unique","conflict":null},{"name":null,"variant":"foreign key","type":"constraint","action":null,"deferrable":null,"target":{"type":"identifier","variant":"table","name":"Hives"},"columns":[{"type":"identifier","variant":"column","name":"id"}]}],"datatype":{"type":"datatype","format":"int","affinity":"integer","args":[]}}]}]}';
    tree.equals(resultTree, this, done);
  });

  it('create check 1', function(done) {
    var resultTree = '{"statement":[{"modifier":null,"type":"statement","variant":"create","format":"table","temporary":false,"target":{"type":"identifier","variant":"table","name":"Bees"},"conditions":[],"definition":[{"type":"definition","variant":"column","name":"id","definition":[{"name":null,"type":"constraint","variant":"primary key","conflict":null,"direction":null,"modififer":null,"autoIncrement":false}],"datatype":{"type":"datatype","format":"int","affinity":"integer","args":[]}},{"type":"definition","variant":"column","name":"name","definition":[{"name":null,"type":"constraint","variant":"not null","conflict":null},{"name":null,"type":"constraint","variant":"unique","conflict":null}],"datatype":{"type":"datatype","format":"varchar","affinity":"text","args":[{"type":"literal","variant":"decimal","value":"50"}]}},{"type":"definition","variant":"column","name":"wings","definition":[{"name":null,"type":"constraint","variant":"check","expression":{"type":"expression","format":"binary","variant":"operation","operation":">=","left":{"type":"identifier","variant":"column","name":"wings"},"right":{"type":"literal","variant":"decimal","value":"2"},"modifier":null}}],"datatype":{"type":"datatype","format":"int","affinity":"integer","args":[]}},{"type":"definition","variant":"column","name":"legs","definition":[{"name":null,"type":"constraint","variant":"check","expression":{"type":"expression","format":"binary","variant":"operation","operation":"<","left":{"type":"identifier","variant":"column","name":"legs"},"right":{"type":"literal","variant":"decimal","value":"8"},"modifier":null}}],"datatype":{"type":"datatype","format":"int","affinity":"integer","args":[]}}]}]}';
    tree.equals(resultTree, this, done);
  });

  it('create check 2', function(done) {
    var resultTree = '{"statement":[{"modifier":null,"type":"statement","variant":"create","format":"table","temporary":false,"target":{"type":"identifier","variant":"table","name":"Bees"},"conditions":[],"definition":[{"type":"definition","variant":"column","name":"id","definition":[{"name":null,"type":"constraint","variant":"primary key","conflict":null,"direction":null,"modififer":null,"autoIncrement":false}],"datatype":{"type":"datatype","format":"int","affinity":"integer","args":[]}},{"type":"definition","variant":"column","name":"name","definition":[{"name":null,"type":"constraint","variant":"not null","conflict":null},{"name":null,"type":"constraint","variant":"unique","conflict":null}],"datatype":{"type":"datatype","format":"varchar","affinity":"text","args":[{"type":"literal","variant":"decimal","value":"50"}]}},{"type":"definition","variant":"column","name":"wings","definition":[],"datatype":{"type":"datatype","format":"int","affinity":"integer","args":[]}},{"type":"definition","variant":"column","name":"legs","definition":[],"datatype":{"type":"datatype","format":"int","affinity":"integer","args":[]}},{"type":"definition","variant":"constraint","name":null,"definition":[{"type":"constraint","variant":"check","expression":{"type":"expression","format":"binary","variant":"operation","operation":"<","left":{"type":"identifier","variant":"column","name":"legs"},"right":{"type":"literal","variant":"decimal","value":"8"},"modifier":null}}]},{"type":"definition","variant":"constraint","name":null,"definition":[{"type":"constraint","variant":"check","expression":{"type":"expression","format":"binary","variant":"operation","operation":">=","left":{"type":"identifier","variant":"column","name":"wings"},"right":{"type":"literal","variant":"decimal","value":"2"},"modifier":null}}]}]}]}';
    tree.equals(resultTree, this, done);
  });

  it('create primary key 1', function(done) {
    var resultTree = '{"statement":[{"modifier":null,"type":"statement","variant":"create","format":"table","temporary":false,"target":{"type":"identifier","variant":"table","name":"Bees"},"conditions":[],"definition":[{"type":"definition","variant":"column","name":"id","definition":[],"datatype":{"type":"datatype","format":"int","affinity":"integer","args":[]}},{"type":"definition","variant":"column","name":"color","definition":[],"datatype":{"type":"datatype","format":"int","affinity":"integer","args":[]}},{"type":"definition","variant":"column","name":"hive_id","definition":[{"name":null,"type":"constraint","variant":"unique","conflict":null}],"datatype":{"type":"datatype","format":"int","affinity":"integer","args":[]}},{"type":"definition","variant":"constraint","name":null,"definition":[{"type":"constraint","variant":"primary key","conflict":"fail"}],"columns":[{"type":"identifier","variant":"column","format":"indexed","direction":"","name":"id","collate":null}]}]}]}';
    tree.equals(resultTree, this, done);
  });
  ...
  it('basic create trigger', function(done) {
    var resultTree = '{"statement":[{"modifier":null,"type":"statement","variant":"create","format":"trigger","when":{"type":"expression","format":"unary","variant":"operation","expression":{"type":"identifier","variant":"column","name":"cust_addr"},"operation":"not null"},"on":"customer_address","target":{"name":"cust_addr_chng","type":"identifier","variant":"trigger"},"conditions":null,"event":{"type":"event","occurs":"instead of","event":"update","of":[{"type":"identifier","variant":"column","name":"cust_addr"}]},"temporary":false,"by":"row","action":[{"modifier":null,"type":"statement","variant":"update","into":{"type":"identifier","variant":"table","name":"customer","alias":null,"index":null},"where":[{"type":"expression","format":"binary","variant":"operation","operation":"=","left":{"type":"identifier","variant":"column","name":"cust_id"},"right":{"type":"identifier","variant":"column","name":"NEW.cust_id"},"modifier":null}],"set":[{"type":"assignment","target":{"type":"identifier","variant":"column","name":"cust_addr"},"value":{"type":"identifier","variant":"column","name":"NEW.cust_addr"}}],"order":null,"limit":null}]}]}';
    tree.equals(resultTree, this, done);
  });
  ...
  it('basic create view', function(done) {
    var resultTree = '{"statement":[{"modifier":null,"type":"statement","variant":"create","format":"view","conditions":null,"temporary":false,"target":{"type":"identifier","variant":"view","name":"happy.bananaView"},"result":{"type":"statement","variant":"select","from":[{"type":"identifier","variant":"table","name":"bananas","alias":null,"index":null}],"where":[{"type":"expression","format":"binary","variant":"operation","operation":"=","left":{"type":"identifier","variant":"column","name":"color"},"right":{"type":"literal","variant":"string","value":"red"},"modifier":null}],"group":null,"result":[{"type":"identifier","variant":"column","name":"type","alias":null},{"type":"identifier","variant":"column","name":"name","alias":null},{"type":"identifier","variant":"column","name":"origin","alias":null}],"distinct":false,"all":false,"order":null,"limit":null}}]}';
    tree.equals(resultTree, this, done);
  });
  ...
  it('basic drop table', function(done) {
    var resultTree = '{"statement":[{"type":"statement","variant":"drop","modifier":null,"format":"table","target":{"type":"identifier","variant":"table","name":"beeStuff"},"conditions":[]}]}';
    tree.equals(resultTree, this, done);
  });

  it('basic drop trigger', function(done) {
    var resultTree = '{"statement":[{"modifier":null,"type":"statement","variant":"drop","format":"trigger","target":{"type":"identifier","variant":"table","name":"happy.insertRecord"},"conditions":[{"type":"condition","condition":"if exists"}]}]}';
    tree.equals(resultTree, this, done);
  });

  it('drop alt syntax', function(done) {
    var resultTree = '{"statement":[{"type":"statement","variant":"drop","modifier":null,"format":"table","target":{"type":"identifier","variant":"table","name":"hive.beeStuff"},"conditions":[{"type":"condition","condition":"if exists"}]}]}';
    tree.equals(resultTree, this, done);
  });
  ...
  it('parse error 1', function(done) {
    tree.error({
      'message': 'There is a syntax error near FROM Clause [FROM Clause, Table Identifier]'
    }, this, done);
  });
