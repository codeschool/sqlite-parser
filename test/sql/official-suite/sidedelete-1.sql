...
;DELETE FROM t1;
      INSERT INTO t1 SELECT a, a FROM sequence WHERE a<=sub_i;
      DELETE FROM chng;
      INSERT INTO chng SELECT a*2, a*2+1 FROM sequence WHERE a<=sub_i/2;
...
;DROP TABLE t1;
     ...
     SELECT * FROM t1
;DELETE FROM t1;
      INSERT INTO t1 SELECT a FROM sequence WHERE a<=sub_i;
