...
;DELETE FROM t1;
      ...
      INSERT INTO t1 VALUES(4)
;SELECT rowid, x FROM t1
;DELETE FROM t1 WHERE rowid=sub_rowid+1
;SELECT * FROM t1
;DELETE FROM t1;
      INSERT INTO t1 VALUES(1);
      INSERT INTO t1 VALUES(2);
...
;DELETE FROM t1;
      ...
      INSERT INTO t1 VALUES(4)
;SELECT rowid, x FROM t1
;UPDATE t1 SET x=x+100 WHERE rowid=sub_rowid
;SELECT * FROM t1
;DELETE FROM t1;
      INSERT INTO t1 VALUES(1)
;SELECT rowid, x FROM t1
;INSERT INTO t1 VALUES(sub_x+1)
;SELECT * FROM t1
;CREATE TABLE t1(x);
      INSERT INTO t1 VALUES(1);
      INSERT INTO t1 VALUES(2);
...
;SELECT rowid, x FROM t1 ORDER BY rowid DESC
;INSERT INTO t1(rowid,x) VALUES(sub_x-1,sub_x-1)
;SELECT * FROM t1
;BEGIN;
