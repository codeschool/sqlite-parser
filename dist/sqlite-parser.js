  ...
  function peg$parse(input) {
    ...
    function peg$parsebinary_divide() {
      ...
      peg$tracer.trace({
        type:     "rule.enter",
        rule:     "binary_divide",
        description: peg$descNames["binary_divide"],
        location: peg$computeLocation(startPos, startPos)
      });
