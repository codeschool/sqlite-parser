module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c256 = { type: "other", description: "Indexed Column" },
        peg$c257 = function(e, c, d) {
            // TODO: Not final format
            return {
              'type': 'identifier',
              'variant': 'column',
        ...
        peg$c258 = function(t) { return _.textNode(t); },
        peg$c259 = function(o, c, t) {
            return {
              'conflict': _.key(t)
            };
          },
        peg$c260 = function(k, c) {
            return {
              'format': _.key(k),
              'expression': c
            };
          },
        peg$c261 = function(k, l, c) {
            return {
        ...
        peg$c265 = function(f, b) { return _.collect([f, b], []); },
        peg$c266 = function(a) { return a; },
        peg$c267 = function(m, a, n) {
            return {
              'type': 'action',
              'variant': _.key(m),
              'action': n
        ...
        peg$c268 = function(a) { return _.key(a); },
        peg$c269 = function(m, n) {
            return {
              'type': 'action',
              'variant': _.key(m),
              'action': n
        ...
        peg$c270 = function(n, d, i) { return _.collect([n, d, i]); },
        peg$c271 = function(s) {
            return {
              'result': s
            };
          },
        peg$c272 = { type: "other", description: "CREATE Trigger" },
        peg$c273 = { type: "other", description: "CREATE View" },
        peg$c274 = { type: "other", description: "CREATE Virtual Table" },
        peg$c275 = { type: "other", description: "DROP Table Statement" },
        peg$c276 = function(s, t, q) {
            return {
              'type': 'statement',
              'variant': s,
              'format': t,
        ...
        peg$c277 = function(i, e) { return _.key(_.compose([i, e])); },
        peg$c278 = function(q, n) { return _.compose([q, n], ''); },
        peg$c279 = /^[a-z0-9\-_]/i,
    ...
    function peg$parsestmt_drop() {
      ...
      if (s1 !== peg$FAILED) {
        ...
        if (s2 !== peg$FAILED) {
          ...
          if (s3 !== peg$FAILED) {
            s4 = peg$parsedrop_name();
            if (s4 !== peg$FAILED) {
              s5 = peg$parseo();
              if (s5 !== peg$FAILED) {
                peg$reportedPos = s0;
                s1 = peg$c276(s1, s2, s4);
                s0 = s1;
              } else {
                peg$currPos = s0;
                s0 = peg$c3;
